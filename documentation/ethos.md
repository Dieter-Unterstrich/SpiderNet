...
Kern: voneinander abhängig, freiwillig, ohne Zwang und ohne Markt.
...
keine Pflicht zum Mitmachen; Erinnerung an Fairness ist Sache des Viertels,
nicht der Software.
...
- Die Software transportiert Dateien/Webseiten aller Art und übernimmt dafür
  **keinerlei Verantwortung** — was übertragen wird, liegt in der
  Verantwortung der Nutzer:innen (Haftungsausschluss, siehe [[Server-README]]).

## 6. Transparenz und offene Technik

Alles ist offen: Code (Lizentscheidung, siehe [[Lizenz]]), Doku, Pläne, auch
die Fehler. Hardware besteht möglichst aus Standardkomponenten (Mini-PC,
SFP-Medienwandler, Standard-Glasfaser), die alle reparieren und beschaffen
können.
...
1. Ich verbinde mein Haus mit dem Netz und lasse Traffic durch (oder leech
   ausdrücklich, siehe §2).
2. Ich benutze das Netz fair (Fair-Share).
3. Ich verantwort mein eigenes Handeln — nicht das Netz, nicht die
   Nachbarn, nicht die Software.
